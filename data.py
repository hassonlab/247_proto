...
import data_pb2
import tfs_constants
from tfs_constants import DATA_DIR_MAP, DATUM_FILE_MAP
...
def get_electrode_folder(project: str, data_dir: str, conversation: str) -> str:
    ...
    """
    electrode_folder = tfs_constants.ELECTRODE_FOLDER_MAP[project][
...
def main(_):
    ...
    if project not in tfs_constants.DATA_DIR_MAP:
